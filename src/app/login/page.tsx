    ...
    <div className="min-h-screen flex items-center justify-center px-4 bg-gradient-to-br from-brand-primaryLight via-background to-brand-secondaryLight">
      ...
      <div className="w-full max-w-md animate-fade-in">
        <div className="flex flex-col items-center mb-6">
          ...
          <p className="text-sm text-textSecondary mt-1">{t("app.tagline")}</p>
        </div>

        <Card>
          <CardContent className="pt-6">
            <div className="mb-6">
              <h2 className="text-xl font-semibold text-textPrimary">{t("auth.welcome")}</h2>
              <p className="text-xs text-textSecondary mt-1">{t("auth.subtitle")}</p>
            </div>
